                        ...
                        <div className="flex flex-row w-full mt-5">
                            ...
                            <div className="flex w-full">
                                <Select
                                    ...
                                    value={focusedBuilding ? focusedBuilding.multipleBuildingLocation.value : locationBuildingDetails.multipleBuildingLocation ? locationBuildingDetails.multipleBuildingLocation : null}
                                    // isMulti
                                    styles={{
                        ...
                        <div className="flex flex-row w-full mt-5">
                            ...
                            <div className="flex w-full">
                                <Input
                                    inputClass="border-gray-500 rounded w-[400px]"
                                    type="text"
                                    value={focusedBuilding ? focusedBuilding.buildingName : ''}
                        ...
                        <div className="flex flex-row w-full mt-5">
                            ...
                            <div className="flex w-full">
                                <Input
                                    inputClass="border-gray-500 rounded w-[400px]"
                                    type="date"
                                    value={focusedBuilding ? focusedBuilding.constructionYear : ''}
                                    onChange={(e) => setLocationBuildingDetails(prev => {
